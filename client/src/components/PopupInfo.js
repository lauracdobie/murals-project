...
function PopupInfo ({murals, popupInfo, instagramLink, instagram2Link}){
    ...
    const instagram2Node = instagram2Link ? (<p>Instagram: <a href={instagram2Link} target="_blank">@{popupInfo.instagram2}</a></p>): null
    return (
        <div className='popup-listing'>
            ...
            <p>Instagram: <a href={instagramLink} target="_blank">@{popupInfo.instagram}</a></p>
            {instagram2Node}
